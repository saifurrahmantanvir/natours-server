...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFudmlycmFobWFuIiwiYSI6ImNsMDlzbzh1dDBkcmozaXJxMmRobGRtdGoifQ.16psFJ8WoUI-4BkcUd7wsA';
...
var stripe = Stripe('pk_test_51KlfuuDuF5Fv1qe8dDSLunbopgPMCFzkAjkRlF7lVkOVlfJGExnnQYUfjnHCJCaeMRzXtHPiiFA0B1RgupwglMnC00pcKdiTPN');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var _document$getElementB = document.getElementById('email'),
        email = _document$getElementB.value;

    var _document$getElementB2 = document.getElementById('password'),
        password = _document$getElementB2.value;
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    var _document$getElementB3 = document.getElementById('name'),
        name = _document$getElementB3.value;

    var _document$getElementB4 = document.getElementById('email'),
        email = _document$getElementB4.value;
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var _document$getElementB5, passwordCurrent, _document$getElementB6, password, _document$getElementB7, passwordConfirm;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _document$getElementB5 = document.getElementById('password-current'), passwordCurrent = _document$getElementB5.value;
              _document$getElementB6 = document.getElementById('password'), password = _document$getElementB6.value;
              _document$getElementB7 = document.getElementById('password-confirm'), passwordConfirm = _document$getElementB7.value;
              _context.next = 7;
